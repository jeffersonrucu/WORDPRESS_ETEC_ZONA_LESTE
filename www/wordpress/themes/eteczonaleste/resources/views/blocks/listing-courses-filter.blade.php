            ...
            <aside class="relative">
                <ul class="bg-secondary dark:bg-secondary-dark rounded-lg p-8 pl-14 flex flex-col gap-3 sticky top-14">
                    <li class="listing-courses-filter__checkbox" role="checkbox" data-filter="">
                        <button class="flex items-center gap-3 relative before:absolute before:top-0 before:bottom-0 before:my-auto before:-left-8 before:w-4 before:h-4 before:rounded before:bg-[#D9D9D9]">
                            Todos
                        </button>
                    </li>
                    ...
                    @foreach($content['filters'] as $filter)
                        <li class="listing-courses-filter__checkbox" role="checkbox" data-filter="{{$filter->term_id}}">
                            <button class="flex items-center gap-3 relative before:absolute before:top-0 before:transition-all before:duration-300 before:bottom-0 before:my-auto before:-left-8 before:w-4 before:h-4 before:rounded before:bg-[#D9D9D9]">
                                {{ $filter->name }}
                            </button>
                        </li>
                    @endforeach
